...
Original file is located at
    https://colab.research.google.com/drive/1jLdGsTrgmPKGesepF5gIGkAbeq7JbFAA
"""
...
#Encode categorical variables (e.g., 'Gender') using LabelEncode
...
# Choose the number of clusters Train the K-Means model with the optimal number of clusters
k = 5
...
#Add cluster labels to the original data and visualize the clusters
data['Cluster'] = kmeans.labels_

#Plot the centroids and visualize the clusters
